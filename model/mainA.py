...
for trial in range(maxTrials):
    ...
    print('\n [--- Trial: '+ str(trial) +' CASE: A ' + str(maxEV) + 'EVs ' + str(chgrRate) + 'kW chgr ' + str(maxPV) + 'PV ' + str(XFMR) + 'kW  ---] \n')    
...
fileName = 'outputData\\A' + str(maxEV) + '-outPxfmr_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outPxfmr)
   
fileName = 'outputData\\A' + str(maxEV) + '-outL1amp_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outL1amp)

fileName = 'outputData\\A' + str(maxEV) + '-outL3amp_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outL3amp)
   
fileName = 'outputData\\A' + str(maxEV) + '-outL7amp_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outL7amp)   

fileName = 'outputData\\A' + str(maxEV) + '-outFaa_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outFaa)
   
fileName = 'outputData\\A' + str(maxEV) + '-outAvgAmps_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
   writer.writerows(outAvgAmps)
   
fileName = 'outputData\\A' + str(maxEV) + '-outAvgPbus_' + str(trial) + '.csv'
#outputFile = open(fileName, 'w')  
with open(fileName, 'w') as outputFile:  
   writer = csv.writer(outputFile)
